...
const inputVariants = cva(
  `
    flex w-full bg-card border border-input shadow-xs shadow-black/5 transition-[color,box-shadow] text-foreground placeholder:text-muted-foreground/60
...
const inputWrapperVariants = cva(
  `
    ...
    [&_[data-slot=input]]:placeholder:text-muted-foreground/60 
